...
<iframe width="560" height="315" src="https://www.youtube.com/embed/gGzqLw8HcH8" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>


DISQUS設定流程
----
創建DISQUS5帳號(可以使用G-mail)，建完帳號會出現上下兩個框框，點選 I want to install disqus in my site，進入設定頁面，Website Name 田入學號 cp2019，Category選取Tech，Language選入"http://學號.github.io/cp2019"，存檔後進入下一個介面，點選正中間Configure your site's community strrings，之後再Shortname後面會有一串剛剛輸入的網址"http://學號.github.io/cp2019"，將他複製到遠端更改SITEURL存檔後結束
